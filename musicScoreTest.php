<?php
	...
	require_once("MFW/modules/musicScore.module.class.php");
	require_once("MFW/modules/musicScoreModule/musicScore.class.php");

	$music = new musicScore;
	$score = 'MFile 1 5 480
MTrk
0 SeqSpec 00 00 41
0 Meta Text "Seq-1"
...
TrkEnd';
	...
	$music->values["musicscore"] = $score;
	$music->breakScoreDown();
	echo '<pre>';
	print_r($music->musicSections);
	echo '</pre>'
?>